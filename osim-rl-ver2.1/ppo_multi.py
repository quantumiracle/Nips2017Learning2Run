...
S_DIM, A_DIM = 43, 18      # state and action dimension
...
class PPO(object):
    ...
    def _build_anet(self, name, trainable):
        with tf.variable_scope(name):
            ...
            sigma +=1e-5 # without this line, 0 value sigma may cause NAN action
...
class Worker(object):
    ...
    def work(self):
        ...
        while not COORD.should_stop():
            ...
            if GLOBAL_EP % 10==0:  # plot every N episode; some error about main thread for plotting
                plt.clf()
